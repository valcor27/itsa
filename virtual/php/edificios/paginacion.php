<?php 
    ...
    if($paginaActual > 1){
        $lista = $lista.'
        <li class="page-item">
            <a class="page-link" href="#Anterior" aria-label="Previous" onclick="Pagination_edificios('.($paginaActual-1).');">
        ...
        if($i == $paginaActual){
            $lista = $lista.'
                <li class="page-item active">
                    <a class="page-link" href="#Paginar" onclick="Pagination_edificios('.$i.');">'.$i.'</a>
                </li>
            ';
        }else{
            $lista = $lista.'
    ...
    if($paginaActual < $nroPaginas){
        $lista = $lista.'
            <li class="page-item">
                <a class="page-link" href="#Siguiente" aria-label="Next" onclick="Pagination_edificios('.($paginaActual+1).');">
    ...
    $consulta_2 = "SELECT id_edificio AS id, nombre_edificio FROM edificio WHERE nombre_edificio LIKE '%$dato%' AND estatus = '1' ORDER BY id_edificio ASC LIMIT $limit, $nroLotes";
