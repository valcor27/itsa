<?php 
    ...
    if($paginaActual > 1){
        $lista = $lista.'
        <li class="page-item">
            <a class="page-link" href="#Anterior" aria-label="Previous" onclick="Pagination_materia('.($paginaActual-1).');">
        ...
        if($i == $paginaActual){
            $lista = $lista.'
                <li class="page-item active">
                    <a class="page-link" href="#Paginar" onclick="Pagination_materia('.$i.');">'.$i.'</a>
                </li>
            ';
        }else{
            $lista = $lista.'
    ...
    if($paginaActual < $nroPaginas){
        $lista = $lista.'
            <li class="page-item">
                <a class="page-link" href="#Siguiente" aria-label="Next" onclick="Pagination_materia('.($paginaActual+1).');">
            ...
            $tabla = $tabla.'
                                <tr>
                                    <td align="center">
                                        ...
                                        <button type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Eliminar Materia" onclick="Eliminar_materia('.$id.');">
