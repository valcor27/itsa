    ...
    switch($proceso){
        case 'Registro':
            ...
            /**---------------------------------------------------------------------------------------------------------------------------------------------------------- */
                ...
                departamento_anterior, departamento_actual, fecha, estatus_documento)VALUES('$id_documento',
                '$departamento_anterior', '$departamento_envio', '$fecha_envio', '$estatus_documento')";
