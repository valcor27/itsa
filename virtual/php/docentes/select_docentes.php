<?php
    ...
    $consulta = "SELECT expediente, primerApellido, segundoApellido, nombres FROM empleados WHERE nivel_idNivelUsuario = '7' AND estatus = '1' ORDER BY expediente";
    $registro = mysqli_query($conexion_database, $consulta);
    /**------------------------------------------------------------ */
    $tabla ='
        <span class="input-group-text"><i class="fa-regular fa-id-badge"></i></span>
        <select class="selectpicker form-control" data-live-search="true" name="exp_doc" id="exp_doc" required="">
