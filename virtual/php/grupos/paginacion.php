<?php 
    ...
    $consulta_2 = "SELECT id_grupo AS id, nombre_grupo, nombre_division FROM grupo WHERE nombre_grupo LIKE '%$dato%' AND estatus = '1' ORDER BY nombre_division ASC LIMIT $limit, $nroLotes";
