<?php 
    ...
    if($paginaActual > 1){
        $lista = $lista.'
        <li class="page-item">
            <a class="page-link" href="#Anterior" aria-label="Previous" onclick="Pagination_grupo('.($paginaActual-1).');">
        ...
        if($i == $paginaActual){
            $lista = $lista.'
                <li class="page-item active">
                    <a class="page-link" href="#Paginar" onclick="Pagination_grupo('.$i.');">'.$i.'</a>
                </li>
            ';
        }else{
            $lista = $lista.'
    ...
    if($paginaActual < $nroPaginas){
        $lista = $lista.'
            <li class="page-item">
                <a class="page-link" href="#Siguiente" aria-label="Next" onclick="Pagination_grupo('.($paginaActual+1).');">
    ...
    $consulta_2 = "SELECT id_grupo AS id, nombre_grupo, nombre_division FROM grupo WHERE nombre_grupo LIKE '%$dato%' AND estatus = '1' ORDER BY nombre_division, nombre_grupo ASC LIMIT $limit, $nroLotes";
