<?php
    ...
    $tabla ='
        ...
        <select class="selectpicker form-control" data-live-search="true" name="exp_emp_comision[]" multiple id="exp_emp_comision" onchange="return Pagination_info_comision();" required="">
            
    ';
    /*$tabla ='
        <span class="input-group-text"><i class="fa-regular fa-id-badge"></i></span>
        <select class="selectpicker form-control" data-live-search="true" name="exp_emp_comision" id="exp_emp_comision" onchange="return Pagination_info_comision();" required="">
