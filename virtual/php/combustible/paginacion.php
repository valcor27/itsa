<?php
    ...
    if($paginaActual > 1){
        $lista = $lista.'
        <li class="page-item">
            <a class="page-link" href="#Anterior" aria-label="Previous" onclick="Pagination_combustible('.($paginaActual-1).');">
        ...
        if($i == $paginaActual){
            $lista = $lista.'
                <li class="page-item active">
                    <a class="page-link" href="#Paginar" onclick="Pagination_combustible('.$i.');">'.$i.'</a>
                </li>
            ';
        }else{
            $lista = $lista.'
    ...
    if($paginaActual < $nroPaginas){
        $lista = $lista.'
            <li class="page-item">
                <a class="page-link" href="#Siguiente" aria-label="Next" onclick="Pagination_combustible('.($paginaActual+1).');">
    ...
    $consulta_2 = "SELECT id_combustible AS id, nombre, precio FROM combustible WHERE (nombre LIKE '%$dato%' OR precio LIKE '%$dato%') AND estatus = '1' ORDER BY nombre ASC LIMIT $limit, $nroLotes";
