<?php
    ...
    if($paginaActual > 1){
        $lista = $lista.'
        <li class="page-item">
            <a class="page-link" href="#Anterior" aria-label="Previous" onclick="Pagination_vehiculo('.($paginaActual-1).');">
        ...
        if($i == $paginaActual){
            $lista = $lista.'
                <li class="page-item active">
                    <a class="page-link" href="#Paginar" onclick="Pagination_vehiculo('.$i.');">'.$i.'</a>
                </li>
            ';
        }else{
            $lista = $lista.'
    ...
    if($paginaActual < $nroPaginas){
        $lista = $lista.'
            <li class="page-item">
                <a class="page-link" href="#Siguiente" aria-label="Next" onclick="Pagination_vehiculo('.($paginaActual+1).');">
    ...
    $consulta_2 = "SELECT idvehiculo AS id, marca, submarca, modelo, placas FROM vehiculo WHERE (placas LIKE '%$dato%' OR noserie LIKE '%$dato%' OR modelo LIKE '%dato%') AND estatus = '1' ORDER BY modelo, marca ASC LIMIT $limit, $nroLotes";
