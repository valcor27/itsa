...
-- Tiempo de generación: 31-10-2024 a las 20:28:21
...
CREATE TABLE IF NOT EXISTS `comision` (
  ...
  `id_empleado` varchar(500) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estructuraorganica` (
  ...
  `nombreUnidad` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `estatus` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pagos` (
  ...
  `ultimo_movimiento` varchar(15) COLLATE latin1_spanish_ci NOT NULL,
  `usuario_movimiento` varchar(7) COLLATE latin1_spanish_ci NOT NULL,
  `estado_checkbox` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_pago`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
